...
public class Oval extends Forma
{
    ...
    public Oval(boolean isFilled, boolean isGradient, boolean isDashedLine, int lineWidth, int dashLength, Color primaryColor, Color secondaryColor, Point p1, Point p2) {
    ...
    public void draw(Graphics g) {
        ...
        if(this.isIsFilled())
        {
            gg.fill(new Ellipse2D.Double(x,y,width,height));
        }
        else
        {
            gg.draw(new Ellipse2D.Double(x,y,width,height));
        }
    }
